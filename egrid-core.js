(function() {
  ...
  onClickVertex = function(arg) {
    var container, vertexText;
    container = arg.container, vertexText = arg.vertexText;
    return function(u) {
      var alreadySelected;
      ...
      if (!alreadySelected) {
        ...
        container.selectAll('g.edge').classed({
          upper: function(_arg) {
            var v, w;
            v = _arg[0], w = _arg[1];
            return ancestors.has(v) && ancestors.has(w);
          },
          lower: function(_arg) {
            var v, w;
            v = _arg[0], w = _arg[1];
            return descendants.has(v) && descendants.has(w);
          }
        });
        ancestors.remove(u);
        ...
        return container.selectAll('g.vertex').classed({
          upper: function(v) {
            return ancestors.has(v);
          },
          lower: function(v) {
            return descendants.has(v);
          }
        });
      }
    };
  ...
  initContainer = function() {
    return function(selection) {
      ...
      if (contents.empty()) {
        ...
        contents.append('rect').classed('background', true);
  ...
  update = function(arg) {
    var vertexScale, vertexText, vertexVisibility;
    vertexScale = arg.vertexScale, vertexText = arg.vertexText, vertexVisibility = arg.vertexVisibility;
    return function(selection) {
  ...
  draw = function(selection) {
    ...
    })).call(layout()).call(transition({
      vertexOpacity: this.vertexOpacity(),
  ...
  this.egrid.core.egm = function(options) {
    var accessor, attr, egm, optionAttributes, val;
    ...
    egm.options = function(options) {
      var attr, _i, _len;
      for (_i = 0, _len = optionAttributes.length; _i < _len; _i++) {
        attr = optionAttributes[_i];
